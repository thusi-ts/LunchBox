    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "Struer", new DateTime(2022, 1, 5, 13, 27, 46, 235, DateTimeKind.Local).AddTicks(7882), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Thusi Selvaratnam", new DateTime(2022, 1, 5, 13, 27, 46, 235, DateTimeKind.Local).AddTicks(8899), null, 0, "password", "23469055", null, "Has authority of users and roles and permissions.", "Kjelding Høj 10", null, "admin", "7600" });

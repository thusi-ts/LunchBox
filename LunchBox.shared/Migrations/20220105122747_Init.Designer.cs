            ...
            modelBuilder.Entity("LunchBox.Shared.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Active = 1,
                            City = "Struer",
                            CreatedTime = new DateTime(2022, 1, 5, 13, 27, 46, 235, DateTimeKind.Local).AddTicks(7882),
                            EnteredTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Fullname = "Thusi Selvaratnam",
                            LastModifiedTime = new DateTime(2022, 1, 5, 13, 27, 46, 235, DateTimeKind.Local).AddTicks(8899),
                            Newsletter = 0,
                            Password = "password",
                            Phone = "23469055",
